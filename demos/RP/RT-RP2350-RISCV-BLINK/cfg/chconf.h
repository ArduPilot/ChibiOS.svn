 ...
 * @note    MTIME on RP2350 runs at 1 MHz. Using 1000 Hz (1ms per tick) gives
 *          a reasonable interrupt rate of 1000/sec instead of 1,000,000/sec.
 */
 ...
 *          this value.
 * @note    Set to 0 for RISC-V Hazard3 port which uses simple periodic
 *          timer mode (not tickless/freerunning mode).
 */
