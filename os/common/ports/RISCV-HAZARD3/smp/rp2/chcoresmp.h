...
/* RP2350 supports a realtime counter via TIMER0 unit, overriding the default in chcore.h */
...
/**
 * @brief   Priority level for the SIO FIFO inter-core IRQ.
 * @details Hazard3 external interrupt priorities are 0-3 (higher = more
 *          urgent). Setting this to the maximum ensures cross-core
 *          reschedule notifications are serviced before peripheral IRQs.
 */
 ...
 * @note    In this port the RT counter uses TIMER0 and resolution is 1uS.
 *
