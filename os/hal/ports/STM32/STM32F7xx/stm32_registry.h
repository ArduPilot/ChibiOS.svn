...
#define STM32_SAI1A_DMA_MSK                 (STM32_DMA_STREAM_ID_MSK(2, 1) |\
                                             STM32_DMA_STREAM_ID_MSK(2, 3) |\
                                             STM32_DMA_STREAM_ID_MSK(2, 6))
#define STM32_SAI1A_DMA_CHN                 0x0A000000
#define STM32_SAI1B_DMA_MSK                 (STM32_DMA_STREAM_ID_MSK(2, 0) |\
                                             STM32_DMA_STREAM_ID_MSK(2, 4) |\
                                             STM32_DMA_STREAM_ID_MSK(2, 5))
#define STM32_SAI1B_DMA_CHN                 0x0001000A
#define STM32_SAI2A_DMA_MSK                 (STM32_DMA_STREAM_ID_MSK(2, 2) |\
                                             STM32_DMA_STREAM_ID_MSK(2, 4))
#define STM32_SAI2A_DMA_CHN                 0x00030A00
#define STM32_SAI2B_DMA_MSK                 (STM32_DMA_STREAM_ID_MSK(2, 1) |\
                                             STM32_DMA_STREAM_ID_MSK(2, 6) |\
                                             STM32_DMA_STREAM_ID_MSK(2, 7))
#define STM32_SAI2B_DMA_CHN                 0x030000A0
