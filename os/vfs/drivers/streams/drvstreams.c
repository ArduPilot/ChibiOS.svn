...
static const struct vfs_streams_driver_vmt driver_vmt = {
  ...
  .vfsdrv.rmdir             = __vfsdrv_rmdir_impl
};
...
vfs_driver_c *drvStreamsObjectInit(vfs_streams_driver_c *vsdp,
  ...
  __bo_objinit_impl(vsdp, &driver_vmt);
